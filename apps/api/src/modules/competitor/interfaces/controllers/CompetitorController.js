...
import { FindAllCompetitors } from "#competitor/application/FindAllCompetitors.js";
...
export class CompetitorController {
  ...
  static async findAll(_, res) {
    ...
    const useCase = new FindAllCompetitors({ competitorRepository });

    const competitors = await useCase.execute();
